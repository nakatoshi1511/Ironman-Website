...
4. Open `http://127.0.0.1:4173/mockups/landingpage-flow.html` in the visible in-app browser.
5. Use only the in-app browser for this startup flow. If it is unavailable or broken, tell the user and ask how to continue.
6. Do not interpret `go` as approval for installations, global CLI changes, plugin setup, or unrelated system changes.

## Ongoing Project Work

- Read `PROJECT_CONTEXT.md` first.
- Check `mockups/landingpage-flow.html`, `mockups/newsfeed.html`, and, for news work, `mockups/news-editor.html`.
